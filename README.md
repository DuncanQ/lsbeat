...
`${GOPATH}/src/github.com/DuncanQ/lsbeat`
...
```
git remote set-url origin https://github.com/DuncanQ/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/DuncanQ/lsbeat
git clone https://github.com/DuncanQ/lsbeat ${GOPATH}/src/github.com/DuncanQ/lsbeat
```
